...
describe("Proof Verification Tests (V2)", function () {
    ...
    before(async function () {
        ...
        console.log("📝 Generating V2 circuit...");
    ...
    describe("Scenario 1: submitCommitment (Step 8a) - Middle Gate", function () {
        it("Should generate correct proofs and verify them in submitCommitment", async function () {
            console.log("\n📊 Scenario 1: submitCommitment (State 2)");
            ...
            console.log(`   ✅ Reached WaitVendorData state after ${roundCount} rounds`);
            ...
            console.log(`   ✅ Proofs generated: ${proofs.values.length} values, proof1 has ${proofs.proof1.length} levels`);
    ...
    describe("Scenario 2: submitCommitmentLeft (Step 8b) - First Gate", function () {
        it("Should generate correct proofs and verify them in submitCommitmentLeft", async function () {
            ...
            if (state !== 3) {
                console.log(`   ⚠️  Could not reach WaitVendorDataLeft state (current: ${state}). Skipping test.`);
                this.skip();
                return;
            }
            
            console.log(`   ✅ Reached WaitVendorDataLeft state after ${roundCount} rounds`);
            ...
            console.log(`   ✅ Proofs generated: ${proofs.values.length} values`);
    ...
    describe("Scenario 3: submitCommitmentRight (Step 8c) - Last Gate", function () {
        it("Should generate correct proofs and verify them in submitCommitmentRight", async function () {
            console.log("\n📊 Scenario 3: submitCommitmentRight (State 4)");
            ...
            if (state !== 4) {
                console.log(`   ⚠️  Could not reach WaitVendorDataRight state (current: ${state}). Skipping test.`);
                this.skip();
                return;
            }
            
            console.log(`   ✅ Reached WaitVendorDataRight state after ${roundCount} rounds`);
            ...
            console.log(`   ✅ Proof generated: ${proof.length} levels`);
    ...
    describe("Proof Generation Validation", function () {
        it("Should verify that hpre_v2 generates correct accumulator for different challenges", async function () {
            ...
            for (let challenge = 1; challenge <= Math.min(10, numGates); challenge++) {
                ...
                console.log(`   ✅ Challenge ${challenge}: hpre_v2 returns valid 32-byte accumulator`);
            }
        });
        
        it("Should verify that proof ranges are consistent", async function () {
            console.log("\n🔍 Testing proof range consistency...");
            ...
            console.log(`   ✅ Proof structure validated for challenge ${challenge}`);
