...
import {DisputeSOXAccountHardcodedSHA256} from "./DisputeSOXAccountHardcodedSHA256.sol";

library DisputeDeployerHardcodedSHA256 {
    function deployDispute(
        ...
        return
            address(
                new DisputeSOXAccountHardcodedSHA256{value: address(this).balance}(
                    _entryPoint,
                    _optimisticContract,
                    _numBlocks,
                    _numGates,
