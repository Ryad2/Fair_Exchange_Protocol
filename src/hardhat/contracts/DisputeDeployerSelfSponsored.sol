...
import {DisputeSOXAccountSelfSponsored} from "./DisputeSOXAccountSelfSponsored.sol";

library DisputeDeployerSelfSponsored {
    function deployDispute(
        ...
        return
            address(
                new DisputeSOXAccountSelfSponsored{value: address(this).balance}(
                    _entryPoint,
                    _optimisticContract,
                    _numBlocks,
                    _numGates,
